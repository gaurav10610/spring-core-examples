...
public class MyAwareService
  ...
  MyAwareService() {
    System.out.println("Aware service no-arg constructor called");
  }
  ...
  public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
    ...
    System.out
        .println("setBeanFactory:: employee bean singleton=" + beanFactory.isSingleton("employee"));
